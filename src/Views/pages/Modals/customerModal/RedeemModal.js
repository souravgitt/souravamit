...
function RedeemModal({modalId, isOpen, removeModal}) {
    return (
        <Modal modalId={modalId} modal={isOpen ? "in" : ""}>
            <ModalDialog>
                <ModalContent>
                    <ModalHeader closeModal={removeModal} modalTitle="Redeem"></ModalHeader>
                    <ModalBody>
                        <div class="giftHistory-content">
                            <form class="form-horizontal">
                                ...
                                <div class="form-group form-fields">
                                    <label class="control-label col-md-4 col-sm-5 col-xs-6" for="pwd">Winnings :</label>
                                    <div class="col-md-8 col-sm-7 col-xs-6">
                                        <p><span>10:10:00</span></p>
                                    </div>
                                </div>
                                <div class="form-group form-fields">
                                    <label class="control-label col-md-4 col-sm-5 col-xs-6" for="pwd">Drawer Balance :</label>
                                    <div class="col-md-8 col-sm-7 col-xs-6">
                                        <p><span>7900</span></p>
                                    </div>
                                </div>
                                <div class="form-group form-fields">
                                    <label class="control-label col-md-4 col-sm-5 col-xs-6" for="pwd">Redeem Amount :</label>
                                    <div class="col-md-8 col-sm-7 col-xs-6">
                                        <p>
                                            <span>0$</span>
                                ...
                                <div class="form-group">
                                    <label class="control-label col-md-4 col-sm-5" for="pwd">Redeem Select :</label>
                                    <div class="col-md-8 col-sm-7 btns-group">
                                        ...
                                        <button type="button" class="btn btn-blue">Max</button>
                                    </div>
                                </div>
                            </form>
                        </div>
